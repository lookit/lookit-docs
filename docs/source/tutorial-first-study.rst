...
To get started, log in to the Lookit staging server as an experimenter. (Go to `<https://lookit.mit.edu/exp/>`_ to log in - bookmark this link if you haven't already.)
